...
Source0  : https://cpan.metacpan.org/authors/id/V/VP/VPIT/Variable-Magic-0.64.tar.gz
...
%prep
%setup -q -n Variable-Magic-0.64
cd %{_builddir}/Variable-Magic-0.64
pushd ..
cp -a Variable-Magic-0.64 buildavx2
popd
